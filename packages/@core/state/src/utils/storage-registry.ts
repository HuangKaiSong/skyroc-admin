 ...
 * Storage registry
 *
 * Decouples atom persistence from concrete storage implementations.
 * App layer registers adapters (e.g. 'local', 'session') at startup;
 * library code resolves them by name at runtime.
 */
