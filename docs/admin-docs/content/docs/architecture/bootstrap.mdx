...
| 主题 | 继续查看 |
| --- | --- |
| 项目目录边界 | `getting-started/project-structure.mdx` |
| 运行、构建和环境模式 | `getting-started/quick-start.mdx` |
| 布局和菜单配置 | `layout/overview.mdx`、`layout/menus-and-tabs.mdx` |
| 路由守卫和权限 | `routing/guards-and-permissions.mdx` |
| 主题、语言和图标 | `theme/overview.mdx`、`theme/i18n-and-icons.mdx` |
