...
| 主题 | 继续查看 |
| --- | --- |
| 启动时如何消费 `BUILD_TIME`、主题、布局和 i18n | `architecture/bootstrap.mdx` |
| 项目启动、构建和预览命令 | `getting-started/quick-start.mdx` |
| 请求实例如何使用 baseURL 和业务 code | `request/overview.mdx` |
| 切换真实后端和代理细节 | `request/proxy-and-backend.mdx` |
