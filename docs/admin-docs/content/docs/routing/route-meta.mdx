...
| `keepAlive` | 页面缓存意图 | 元信息类型已预留，是否生效取决于布局和 tabs 实现。 |
...
| 主题 | 继续查看 |
| --- | --- |
| 页面文件如何生成路由 | `routing/overview.mdx` |
| 登录拦截和 403 判断 | `routing/guards-and-permissions.mdx` |
| 菜单分类、扩展节点和 tabs | `layout/menus-and-tabs.mdx` |
| 国际化 key 和图标资源 | `theme/i18n-and-icons.mdx` |
