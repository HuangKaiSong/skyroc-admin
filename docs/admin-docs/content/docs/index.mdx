...
| 目标                      | 阅读路径                                                                                                                                                          |
| ------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 先把项目跑起来            | [快速开始](./getting-started/quick-start)、[开发工具配置](./getting-started/editor-setup)、[项目结构](./getting-started/project-structure)                         |
...
| 新增页面和路由            | [路由概览](./routing/overview)、[路由元信息](./routing/route-meta)、[权限守卫](./routing/guards-and-permissions)                                                  |
...
| 写管理页列表和表单        | [表格与表单](./features/table-and-form)、[示例页面边界](./features/demo-pages)                                                                                    |
