...
| 主题 | 文档 |
| --- | --- |
| 项目约定（命名、组件风格、提交规范） | [开发约定](/docs/engineering/conventions) |
| TypeScript 策略与全局类型 | [TypeScript 配置](/docs/engineering/typescript) |
| 构建体系（Turborepo + Vite + tsdown） | [构建体系](/docs/engineering/build-system) |
| package.json exports / 子入口策略 | [Exports 策略](/docs/engineering/exports-strategy) |
| 如何新建一个包 | [新建包流程](/docs/engineering/new-package) |
| Lint / Format | [Lint 与格式化](/docs/engineering/lint-and-format) |
| 测试理念与方案 | [测试](/docs/engineering/test) |
| 提交 / 发版 | [Git 提交与发版](/docs/engineering/git-commit) |
| CI / CD | [CI](/docs/engineering/ci) |
...
| **No useCallback** | 项目代码风格禁用 `useCallback`，详见 [开发约定](/docs/engineering/conventions) |
