...
详见 [Exports 策略](/docs/engineering/exports-strategy)。
...
## 与 [Monorepo](/docs/architecture/monorepo) / [Catalog](/docs/architecture/catalog) 的协作

- Monorepo 决定**谁**被构建（workspaces）；
- Catalog 决定**版本**（中心化）；
