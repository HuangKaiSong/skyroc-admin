...
const GROUPS: ComponentGroup[] = [
  {
    ...
    items: [
      ...
      {
        href: '/components/number-keyboard',
        icon: 'calculator',
        iconColor: '#0891b2',
        iconBg: '#ecfeff',
...
const HomeScreen = () => {
  ...
  return (
    ...
    >
      {/* Header */}
      <View className="bg-primary px-6 pb-8 pt-4">
