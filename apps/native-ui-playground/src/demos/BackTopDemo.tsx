...
const BackTopDemo = () => {
  ...
  return (
    <View className="flex-1 bg-background">
      <Animated.ScrollView ref={scrollRef} className="flex-1" contentContainerClassName="p-6" scrollEventThrottle={16}>
        ...
        {Array.from({ length: 50 }, (_, i) => (
          <View key={i} className="mb-3 rounded-lg bg-card p-4">
