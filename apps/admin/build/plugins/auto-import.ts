...
/**
 * TanStack Router 的 autoCodeSplitting 会把组件拆成虚拟模块 虚拟模块 ID 格式：原文件路径?tsr-split=component
 *
 * 原本的 /.[tj]sx?$/ 要求文件 ID 以 .ts/.tsx/.js/.jsx 结尾 但虚拟模块 ID 如 "index.tsx?tsr-split=component" 以 query string 结尾
 *
