...
`ConfigProvider` 的完整用法请参考 [主题系统](/docs/theming)。
...
<Cards>
  <Card title="主题系统" description="颜色、尺寸、ConfigProvider 全局配置" href="/docs/theming" />
  <Card title="Button" description="从最常用的按钮组件开始探索" href="/docs/components/button" />
</Cards>
